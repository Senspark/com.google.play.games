    ...
    public static class GPGSUtil
    {
        ...
        public static string RootPath
        {
            get
            {
                ...
                {
                    // Search for root path in UPM packages
                    var fPath = Path.GetFullPath($"Packages/{RootFolderName}");
                    var rPath = Directory.GetCurrentDirectory();
                    mRootPath = Path.GetRelativePath(rPath, fPath);
                }
                return mRootPath;
            }
        }
